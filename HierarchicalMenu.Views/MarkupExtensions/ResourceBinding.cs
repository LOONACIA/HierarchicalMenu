...
// https://referencesource.microsoft.com/#system/compmod/system/componentmodel/TypeDescriptor.cs //
...
namespace HierarchicalMenu.Views.MarkupExtensions;
...
public class ResourceBinding : MarkupExtension
{
	...
	static void ResourceKeyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
	{
		...
		var typeConverter = TypeDescriptor.GetConverter(newVal.Item1.GetType());
		var value = typeConverter?.ConvertTo(newVal.Item1, typeof(string)) ?? newVal.Item1;
